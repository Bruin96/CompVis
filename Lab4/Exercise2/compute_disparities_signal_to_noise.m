function dispars = compute_disparities_signal_to_noise(im1, im2, win_height, win_width)
    [M, N] = size(im1);
    dispars = zeros(M, N);
    ...
    parfor x = x_bottom:x_top
        for y = y_bottom:y_top
            ...
            for d = lower_bound:upper_bound % Try all possible disparities
                abs_diff_val = compute_signal_to_noise_ratio(padded_im1, padded_im2, win_height, win_width, x, y, d);
